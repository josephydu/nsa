...
def test_no_causal():
    ...
    ref_o, ref_s, kt = attention_ref(q_ref_t, k_ref_t, v_ref_t, compress_block_stride, compress_block_size, causal=False, scale=None)
    ...
    #torch.testing.assert_close(kt.grad.reshape(-1, 4, 128), k.grad, rtol=3e-2, atol=3e-2)
